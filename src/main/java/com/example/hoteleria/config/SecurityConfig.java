...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .and()
                .authorizeHttpRequests().requestMatchers(HttpMethod.GET,"/api/v1/clientes","/api/v1/reservas","/api/v1/reservas/**").hasAuthority("ADMIN")
                .and()
                ...
                .and()
                .authorizeHttpRequests().requestMatchers(HttpMethod.PUT,"/api/v1/habitaciones/**").hasAuthority("ADMIN")
                .and()
